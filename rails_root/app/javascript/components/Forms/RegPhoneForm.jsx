...
class RegPhoneForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      email: '',
  ...
  handleInputChange = (event) => {
   ...
   handleSubmit = async (e) => {
     ...
     let json;
     try {
       json = await AppDataManager.api('/registration', { method: 'POST', parameters: { user: { phone, password } } });
     } catch (e) {
...
export default connect(null, mapDispatchToProps)(RegPhoneForm);
