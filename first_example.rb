...
after_bundle do
  ...
  run 'yarn add bootstrap chart.js classnames history match-sorter moment node-sass nouislider perfect-scrollbar prop-types react react-big-calendar react-bootstrap-sweetalert react-bootstrap-switch react-bootstrap-wizard react-chartjs-2 react-datetime react-dom react-google-maps react-jvectormap react-notification-alert react-router-dom react-scripts react-select react-table react-tagsinput reactstrap'
